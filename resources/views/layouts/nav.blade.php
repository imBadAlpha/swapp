    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <form class="search-form d-flex align-items-center" method="GET" action="/search/query">
            @csrf
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <li class="nav-item">
            <a class="nav-link @if($current_page == 'Profile') active @else collapsed @endif" href="profile" >
            <i class="bi bi-person"></i>
            <span>Profile</span>
            </a>
