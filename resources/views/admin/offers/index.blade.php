@include('admin.layouts.head', ['current_page' => 'Offers Management'])

  @include('admin.layouts.nav', ['current_page' => 'Offers Management'])
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><span class="badge {{ $post->status == 'active' ? 'bg-warning' : 'bg-danger' }}">{{ $offer->status }}</span></td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
